"""Reuse the verified coordinator with new paths and no duplicate initial eval."""
from pathlib import Path

source=Path(__file__).with_name('run_answer_pool.py').read_text()
edits=[('import answer_pool_experiment as prep','import answer_pool_controls as prep',1),
       ("REPO/'scripts/answer_pool_experiment.py'","REPO/'scripts/answer_pool_controls.py'",3),
